 ...
 * @author YLEM DIOSES
 */
public class SelectionListenerPed implements ListSelectionListener {
    private final JTable table;

    public SelectionListenerPed(JTable table) {
        this.table = table;
    }
    @Override
    public void valueChanged(ListSelectionEvent e) {
        ...
        for (int i = 0; i < table.getColumnCount(); i++) {
            ...
            CustomRendererPed customRenderer = new CustomRendererPed();
